...
function isMerchantCommandResult(result) {
...
const handleDmSend = async (context) => {
    ...
    */
    if (isMerchantCommandResult(result)) {
        ...
        const merchantResponseMessage = result.merchantResponseMessage;
        console.log("[MERCHANT_DM_COMMAND_HANDLED]", {
            ...
            responseMessageId: merchantResponseMessage.messageId,
            requestId: context.message.request_id,
            at: new Date().toISOString(),
        });
        /*
        ...
        */
        (0, ws_utils_1.sendSuccess)(context.socket, {
            ...
            fromUsername: merchantResponseMessage.fromUsername,
            fromPhotoUrl: merchantResponseMessage.fromPhotoUrl,
            targetHidden: false,
            isMerchantCommand: true,
        });
        return;
