...
//   }
//   /*
//     نأخذ نسخة من الوسائط قبل حذف التويتة.
//   */
//   const tweetMedia =
//     Array.isArray(tweet.media)
//       ? tweet.media.map(
...
//   });
//   /*
//     حذف كل البيانات المرتبطة بالتويتة.
//   */
//   await Promise.all([
...
//   ]);
//   /*
//     إزالة التويتة من قائمة انتهاء Redis.
//   */
//   try {
...
async function buildTweetResponse(input) {
    ...
    const [author, like, retweet,] = await Promise.all([
