...
exports.WS_EVENTS = exports.WS_HANDLERS = void 0;
exports.WS_HANDLERS = {
    ...
    */
    ...
    TWEETS_FEED: "tweets.feed",
    TWEETS_DETAILS: "tweets.details",
    TWEETS_LIKE_TOGGLE: "tweets.like.toggle",
    TWEETS_RETWEET_TOGGLE: "tweets.retweet.toggle",
    TWEETS_VIEW: "tweets.view",
    TWEETS_COMMENT_CREATE: "tweets.comment.create",
    TWEETS_COMMENT_UPDATE: "tweets.comment.update",
    TWEETS_COMMENT_DELETE: "tweets.comment.delete",
    TWEETS_COMMENTS_LIST: "tweets.comments.list",
};
exports.WS_EVENTS = {
    ...
    FRIEND_REQUESTS_INCOMING_LIST_EVENT: "friend_requests_incoming_list_event",
    ...
    */
    ...
    TWEETS_CREATE_EVENT: "tweets.create_event",
    TWEETS_DELETE_EVENT: "tweets.delete_event",
    TWEETS_FEED_EVENT: "tweets.feed_event",
    TWEETS_DETAILS_EVENT: "tweets.details_event",
    TWEETS_LIKE_EVENT: "tweets.like_event",
    TWEETS_RETWEET_EVENT: "tweets.retweet_event",
    TWEETS_VIEW_EVENT: "tweets.view_event",
    TWEETS_COMMENT_EVENT: "tweets.comment_event",
    TWEETS_COMMENTS_EVENT: "tweets.comments_event",
    TWEETS_ERROR_EVENT: "tweets.error_event",
    TWEETS_COOLDOWN_EVENT: "tweets.cooldown_event",
};
