...
export type RoomLiveMessage = {
  ...
  /*
    بيانات الرسالة الأصلية التي يتم الرد عليها.
    لا يوجد عدد للردود.
  */
  replyTo: {
    messageId: string;
  ...
  /*
    الرياكشنات مجمعة حسب الإيموجي.

    count:
    عدد المستخدمين الذين وضعوا هذا الرياكشن.

    users:
    القائمة التي تظهر عند الضغط على الرياكشن.
  */
  reactions: {
    emoji: string;
    count: number;
