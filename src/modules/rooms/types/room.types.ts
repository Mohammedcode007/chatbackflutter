...
verificationType?: string;
  /*
    بيانات بادج مرسل الرسالة.

    fromBadgeValue:
    بادج الإيموجي القديم مثل ⭐ 👑 🔥.

    fromBadgeImageUrl:
    رابط صورة البادج الجديدة مثل نسر / أسد / جمجمة.

    fromBadgeLottieUrl:
    رابط ملف Lottie JSON للبادج المتحرك.

    جعلناهم optional حتى لا نكسر رسائل:
    system / gift / entry_video
    لأنها قد لا ترسل هذه الحقول الآن.
  */
